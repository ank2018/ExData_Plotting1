...
# plot histogram - household global minute-averaged active power (in kilowatt)
hist(readfebdata$Global_active_power,  col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)")
